# ![Markdown Intro](https://itx-man.github.io/img/title.png)
...
```
行内式 [博客](https://itx-man.github.io "我的个人博客") 链接，带 title。

行内式 [GitHub](https://github.com/itx-man) 链接。

引用式 [博客][1] 链接。

引用式 [GitHub][2] 链接，带 title。

[1]: https://itx-man.github.io
[2]: https://github.com/itx-man "我的 GitHub 主页"
```
...
```html
<p>行内式 <a href="https://itx-man.github.io" title="我的个人博客">博客</a> 链接，带 title。</p>

<p>行内式 <a href="https://github.com/itx-man">GitHub</a> 链接。</p>

<p>引用式 <a href="https://itx-man.github.io">博客</a> 链接。</p>

<p>引用式 <a href="https://github.com/itx-man" title="我的 GitHub 主页">GitHub</a> 链接，带 title。</p>
```
...
```
![Alt text](https://itx-man.github.io/img/favicon.ico "favicon")
```
...
```html
<img src="https://itx-man.github.io/favicon.ico" alt="Alt text" title="favicon">
```
...
![task list 1](https://itx-man.github.io/img/task-list-1.png)

还可以直接在网页上拖动调整顺序，勾选和取消勾选。

![task list 2](https://itx-man.github.io/img/task-list-2.png)
...
![流程图]https://itx-man.github.io/img/tapd-markdown-flowchart.png)

![时序图](https://itx-man.github.io/img/tapd-markdown-seq.png)

### 插入数学公式

仍然以 TAPD 为例：

![数学公式](https://itx-man.github.io/img/tapd-markdown-math.png)
...
![微信公众号](https://itx-man.github.io/img/wechat-markdown.png)
